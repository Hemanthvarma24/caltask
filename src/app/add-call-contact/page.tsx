...
export default function SelectContactPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-16">
      {/* Header */}
      <header className="sticky top-0 z-10 bg-Caltrak-primary text-white py-4">
          ...
          <ul className="divide-y divide-gray-200">
            ...
            <li>
              <Link href="/group/new" className="flex items-center py-3">
                <div className="w-12 h-12 rounded-full bg-Caltrak-primary flex items-center justify-center mr-3">
